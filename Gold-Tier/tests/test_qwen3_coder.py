...
from scripts.qwen_ai_integration import call_qwen_coder, call_ai_model
...
print("\n=== Testing unified AI model function ===")
response2 = call_ai_model(prompt, vault_path="AI_Employee_Vault", timeout=30, model="qwen3-coder:480b-cloud")
print(f"\n=== Response (length: {len(response2) if response2 else 0}) ===")
print(response2)