...
2. **Plan Generation** - Auto-create detailed plans for tasks
3. **MCP Server** - Integrate one external action (e.g., send email)
4. **Scheduling** - Set up cron/Task Scheduler for automated runs
